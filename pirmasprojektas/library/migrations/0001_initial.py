# Generated by Django 4.1.7 on 2023-03-06 19:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(max_length=1000, verbose_name='Vardas')),
                ('last_name', models.CharField(max_length=1000, verbose_name='Pavardė')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isbn', models.CharField(help_text='13 simboliu ... -> isbn url', max_length=13, verbose_name='ISBN')),
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ManyToManyField(help_text='Issirinkite zanra(us) siai knygai', to='library.genre'),
        ),
    ]
